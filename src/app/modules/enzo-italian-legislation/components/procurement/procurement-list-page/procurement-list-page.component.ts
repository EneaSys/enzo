...
export class EnzoProcurementListPageComponent extends EnzoGenericComponent1 {
    constructor(
		private router: Router,
		public _gcs: EnzoGenericComponentService1,
	) {
		super(_gcs);
		this.tmCurrentComponent.name = "Procurement list";
	}

	procurementListPaginator: AgalPaginator = {
		page: 0,
		size: 30
	};
