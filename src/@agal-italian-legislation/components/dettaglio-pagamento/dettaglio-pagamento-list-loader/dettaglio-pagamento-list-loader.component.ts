...
import {dettaglio-pagamentoResourceService } from 'aig-dettaglio-pagamento';
...
export class AgalDettaglioPagamentoListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllDettaglioPagamentoUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countDettaglioPagamentoUsingGET(filters).toPromise();
