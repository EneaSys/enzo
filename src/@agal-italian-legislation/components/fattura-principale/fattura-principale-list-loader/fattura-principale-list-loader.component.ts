...
import {fattura-principaleResourceService } from 'aig-fattura-principale';
...
export class AgalFatturaPrincipaleListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllFatturaPrincipaleUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countFatturaPrincipaleUsingGET(filters).toPromise();
