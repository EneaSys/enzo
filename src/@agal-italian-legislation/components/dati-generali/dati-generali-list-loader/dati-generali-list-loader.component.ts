...
import {dati-generaliResourceService } from 'aig-dati-generali';
...
export class AgalDatiGeneraliListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllDatiGeneraliUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countDatiGeneraliUsingGET(filters).toPromise();
