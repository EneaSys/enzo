...
import {dati-ritenutaResourceService } from 'aig-dati-ritenuta';
...
export class AgalDatiRitenutaListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllDatiRitenutaUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countDatiRitenutaUsingGET(filters).toPromise();
