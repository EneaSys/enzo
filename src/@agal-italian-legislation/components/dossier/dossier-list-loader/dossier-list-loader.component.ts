...
import {dossierResourceService } from 'aig-dossier';
...
export class AgalDossierListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllDossierUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countDossierUsingGET(filters).toPromise();
