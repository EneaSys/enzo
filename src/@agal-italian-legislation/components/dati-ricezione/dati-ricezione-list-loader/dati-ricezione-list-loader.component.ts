...
import {dati-ricezioneResourceService } from 'aig-dati-ricezione';
...
export class AgalDatiRicezioneListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllDatiRicezioneUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countDatiRicezioneUsingGET(filters).toPromise();
