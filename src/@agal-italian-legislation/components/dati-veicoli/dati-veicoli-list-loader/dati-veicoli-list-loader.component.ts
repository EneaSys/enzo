...
import {dati-veicoliResourceService } from 'aig-dati-veicoli';
...
export class AgalDatiVeicoliListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllDatiVeicoliUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countDatiVeicoliUsingGET(filters).toPromise();
