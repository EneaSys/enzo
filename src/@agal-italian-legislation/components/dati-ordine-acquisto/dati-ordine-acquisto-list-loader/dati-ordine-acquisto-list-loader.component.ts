...
import {dati-ordine-acquistoResourceService } from 'aig-dati-ordine-acquisto';
...
export class AgalDatiOrdineAcquistoListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllDatiOrdineAcquistoUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countDatiOrdineAcquistoUsingGET(filters).toPromise();
