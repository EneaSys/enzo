...
import {dati-trasmissioneResourceService } from 'aig-dati-trasmissione';
...
export class AgalDatiTrasmissioneListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllDatiTrasmissioneUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countDatiTrasmissioneUsingGET(filters).toPromise();
