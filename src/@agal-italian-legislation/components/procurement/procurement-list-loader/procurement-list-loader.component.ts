...
import {procurementResourceService } from 'aig-procurement';
...
export class AgalProcurementListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllProcurementUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countProcurementUsingGET(filters).toPromise();
