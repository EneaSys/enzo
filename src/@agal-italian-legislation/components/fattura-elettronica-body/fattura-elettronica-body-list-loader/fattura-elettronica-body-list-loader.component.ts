...
import {fattura-elettronica-bodyResourceService } from 'aig-fattura-elettronica-body';
...
export class AgalFatturaElettronicaBodyListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllFatturaElettronicaBodyUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countFatturaElettronicaBodyUsingGET(filters).toPromise();
