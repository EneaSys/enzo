...
import {dati-generali-documentoResourceService } from 'aig-dati-generali-documento';
...
export class AgalDatiGeneraliDocumentoListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllDatiGeneraliDocumentoUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countDatiGeneraliDocumentoUsingGET(filters).toPromise();
