...
import {terzo-intermediario-o-soggetto-emittenteResourceService } from 'aig-terzo-intermediario-o-soggetto-emittente';
...
export class AgalTerzoIntermediarioOSoggettoEmittenteListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllTerzoIntermediarioOSoggettoEmittenteUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countTerzoIntermediarioOSoggettoEmittenteUsingGET(filters).toPromise();
