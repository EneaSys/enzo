...
import {dati-salResourceService } from 'aig-dati-sal';
...
export class AgalDatiSalListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllDatiSalUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countDatiSalUsingGET(filters).toPromise();
