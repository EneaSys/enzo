...
import {cedente-prestatoreResourceService } from 'aig-cedente-prestatore';
...
export class AgalCedentePrestatoreListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllCedentePrestatoreUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countCedentePrestatoreUsingGET(filters).toPromise();
