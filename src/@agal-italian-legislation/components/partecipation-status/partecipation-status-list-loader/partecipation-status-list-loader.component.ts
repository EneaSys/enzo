...
import {partecipation-statusResourceService } from 'aig-partecipation-status';
...
export class AgalPartecipationStatusListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllPartecipationStatusUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countPartecipationStatusUsingGET(filters).toPromise();
