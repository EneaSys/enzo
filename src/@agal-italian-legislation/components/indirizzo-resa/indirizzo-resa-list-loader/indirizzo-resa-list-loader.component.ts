...
import {indirizzo-resaResourceService } from 'aig-indirizzo-resa';
...
export class AgalIndirizzoResaListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllIndirizzoResaUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countIndirizzoResaUsingGET(filters).toPromise();
