...
import {dati-riepilogoResourceService } from 'aig-dati-riepilogo';
...
export class AgalDatiRiepilogoListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllDatiRiepilogoUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countDatiRiepilogoUsingGET(filters).toPromise();
