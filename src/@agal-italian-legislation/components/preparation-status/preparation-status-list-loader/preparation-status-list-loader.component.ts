...
import {preparation-statusResourceService } from 'aig-preparation-status';
...
export class AgalPreparationStatusListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllPreparationStatusUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countPreparationStatusUsingGET(filters).toPromise();
