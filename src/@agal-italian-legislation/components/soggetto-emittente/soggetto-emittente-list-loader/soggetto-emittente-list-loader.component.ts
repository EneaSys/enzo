...
import {soggetto-emittenteResourceService } from 'aig-soggetto-emittente';
...
export class AgalSoggettoEmittenteListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllSoggettoEmittenteUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countSoggettoEmittenteUsingGET(filters).toPromise();
