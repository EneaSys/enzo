...
import {preparation-modalityResourceService } from 'aig-preparation-modality';
...
export class AgalPreparationModalityListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllPreparationModalityUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countPreparationModalityUsingGET(filters).toPromise();
