...
import {procurement-lot-categoryResourceService } from 'aig-procurement-lot-category';
...
export class AgalProcurementLotCategoryListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllProcurementLotCategoryUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countProcurementLotCategoryUsingGET(filters).toPromise();
