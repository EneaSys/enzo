...
import {sconto-maggiorazione-lineaResourceService } from 'aig-sconto-maggiorazione-linea';
...
export class AgalScontoMaggiorazioneLineaListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllScontoMaggiorazioneLineaUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countScontoMaggiorazioneLineaUsingGET(filters).toPromise();
