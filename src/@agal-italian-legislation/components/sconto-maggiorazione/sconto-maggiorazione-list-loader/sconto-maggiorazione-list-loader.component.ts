...
import {sconto-maggiorazioneResourceService } from 'aig-sconto-maggiorazione';
...
export class AgalScontoMaggiorazioneListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllScontoMaggiorazioneUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countScontoMaggiorazioneUsingGET(filters).toPromise();
