...
import {dettaglio-lineaResourceService } from 'aig-dettaglio-linea';
...
export class AgalDettaglioLineaListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllDettaglioLineaUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countDettaglioLineaUsingGET(filters).toPromise();
