...
import {partecipation-modalityResourceService } from 'aig-partecipation-modality';
...
export class AgalPartecipationModalityListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllPartecipationModalityUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countPartecipationModalityUsingGET(filters).toPromise();
