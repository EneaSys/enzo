...
import {insurance-policyResourceService } from 'aig-insurance-policy';
...
export class AgalInsurancePolicyListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllInsurancePolicyUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countInsurancePolicyUsingGET(filters).toPromise();
