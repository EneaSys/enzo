...
import {designated-companyResourceService } from 'aig-designated-company';
...
export class AgalDesignatedCompanyListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllDesignatedCompanyUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countDesignatedCompanyUsingGET(filters).toPromise();
