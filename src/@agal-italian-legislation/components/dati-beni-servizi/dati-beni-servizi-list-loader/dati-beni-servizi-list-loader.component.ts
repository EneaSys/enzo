...
import {dati-beni-serviziResourceService } from 'aig-dati-beni-servizi';
...
export class AgalDatiBeniServiziListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllDatiBeniServiziUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countDatiBeniServiziUsingGET(filters).toPromise();
