...
import {dati-pagamentoResourceService } from 'aig-dati-pagamento';
...
export class AgalDatiPagamentoListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllDatiPagamentoUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countDatiPagamentoUsingGET(filters).toPromise();
