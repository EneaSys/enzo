...
import {procurement-lotResourceService } from 'aig-procurement-lot';
...
export class AgalProcurementLotListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllProcurementLotUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countProcurementLotUsingGET(filters).toPromise();
