...
import {preparationResourceService } from 'aig-preparation';
...
export class AgalPreparationListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllPreparationUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countPreparationUsingGET(filters).toPromise();
