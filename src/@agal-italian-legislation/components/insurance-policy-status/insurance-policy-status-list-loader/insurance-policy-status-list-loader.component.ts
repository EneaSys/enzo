...
import {insurance-policy-statusResourceService } from 'aig-insurance-policy-status';
...
export class AgalInsurancePolicyStatusListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllInsurancePolicyStatusUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countInsurancePolicyStatusUsingGET(filters).toPromise();
