...
import {dati-cassa-previdenzialeResourceService } from 'aig-dati-cassa-previdenziale';
...
export class AgalDatiCassaPrevidenzialeListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllDatiCassaPrevidenzialeUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countDatiCassaPrevidenzialeUsingGET(filters).toPromise();
