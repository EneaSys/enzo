...
import {partecipationResourceService } from 'aig-partecipation';
...
export class AgalPartecipationListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllPartecipationUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countPartecipationUsingGET(filters).toPromise();
