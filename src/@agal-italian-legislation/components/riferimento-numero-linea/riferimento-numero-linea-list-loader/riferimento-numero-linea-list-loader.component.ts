...
import {riferimento-numero-lineaResourceService } from 'aig-riferimento-numero-linea';
...
export class AgalRiferimentoNumeroLineaListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllRiferimentoNumeroLineaUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countRiferimentoNumeroLineaUsingGET(filters).toPromise();
