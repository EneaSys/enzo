...
import {dati-contrattoResourceService } from 'aig-dati-contratto';
...
export class AgalDatiContrattoListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllDatiContrattoUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countDatiContrattoUsingGET(filters).toPromise();
