...
import {dati-ddtResourceService } from 'aig-dati-ddt';
...
export class AgalDatiDdtListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllDatiDdtUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countDatiDdtUsingGET(filters).toPromise();
