...
import {allegatiResourceService } from 'aig-allegati';
...
export class AgalAllegatiListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllAllegatiUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countAllegatiUsingGET(filters).toPromise();
