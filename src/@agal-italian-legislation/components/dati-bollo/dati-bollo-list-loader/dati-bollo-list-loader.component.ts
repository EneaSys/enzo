...
import {dati-bolloResourceService } from 'aig-dati-bollo';
...
export class AgalDatiBolloListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllDatiBolloUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countDatiBolloUsingGET(filters).toPromise();
