...
import {dati-fatture-collegateResourceService } from 'aig-dati-fatture-collegate';
...
export class AgalDatiFattureCollegateListLoaderComponent extends AgalGenericComponent implements OnInit {
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllDatiFattureCollegateUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countDatiFattureCollegateUsingGET(filters).toPromise();
